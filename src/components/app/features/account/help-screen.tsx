...
const FAQ: FaqEntry[] = [
  {
    q: "كيف أفعّل حسابي؟",
    a: "سجّل برقمك اليمني (9 أرقام تبدأ بـ7)، أدخل رمز التحقق الذي وصلك، ثم عيّن رمز PIN من 6 أرقام وفعّل تطبيق المصادقة. حسابك يعمل فوراً بمستوى «غير موثّق» ويمكنك رفع مستواه لاحقاً بالتوثيق.",
  },
  {
  ...
  },
  {
    ...
    a: "بعد 3 محاولات خاطئة يُقفل الرمز 5 دقائق، وبعد 6 محاولات 30 دقيقة ثم يعمل مجدداً. لا توجد إعادة تعيين ذاتية للرمز: افتح تذكرة دعم من فئة «حساب» وسيتحقق الفريق من هويتك ويعيد ضبطه لك. وإن فقدت جهاز المصادقة فاستخدم أحد رموز الاسترداد الثمانية التي حصلت عليها عند التفعيل، أو تواصل بالدعم لإعادة التفعيل. إن اشتبهت باستخدام غيرك لحسابك أنهِ كل الجلسات الأخرى من «أجهزتي» فوراً.",
  },
  {
  ...
  },
  {
    ...
    a: "الخدمات تُطلق تباعاً وفق خارطة الطريق، وحالة كل خدمة (متاحة / قريباً / صيانة) تظهر لحظياً في قسم الخدمات الرئيسي. الحوالة الواردة من شبكات الصرافة خارجية قادمة أيضاً لاحقاً.",
  },
];
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-[#E8E6E1]/70 bg-[#F7F6F2] p-3.5 opacity-90">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[12px] font-medium leading-5 text-[#A3A09B]">
              محادثة فورية مع فريق الدعم — قريباً
            </p>
          </div>
