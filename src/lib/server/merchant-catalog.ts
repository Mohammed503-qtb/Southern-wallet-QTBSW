/**
 * محفظة الجنوب — إثراء عرض التجار (MERCHANT_PAY — 9-c)
 * ---------------------------------------------------------
 * سجل ثابت للبيانات الغنية (الفئة/المحافظة) — الدفع يعتمد كلياً على قاعدة
...
/** سجل إثراء العرض (البحث والدفع دائماً من DB — غير المعروف يأخذ قيماً عامة) */
