...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  "AUTH-004": "يرجى الانتظار قبل إعادة إرسال الرمز",
  ...
  // إضافة Beta الإنتاجية (المهمة 11): حد المعدل + تعطيل الدخول التجريبي + فحص الصحة
  "SYS-002": "طلبات كثيرة جداً — انتظر قليلاً ثم أعد المحاولة",
  "SYS-003": "قاعدة البيانات غير متاحة",
  "AUTH-006": "الدخول التجريبي معطّل في هذه البيئة",
};
